...
var ImageNotNewerVersionError = require('../errors/image-not-newer-version-error');
  ...
  proto.build = function () {
    return this
      ...
      .then(function (images) {
        ...
        if (remoteNewer) {
          throw new ImageNotNewerVersionError(this.opts.meta.repo, this.opts.meta.version);
        }
      })
